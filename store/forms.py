...
class AddressForm(forms.ModelForm):
    class Meta:
        model = Address
        fields = ['flat_no','building_name','locality', 'city', 'state']
        widgets = {'flat_no':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Enter House No.'}),'building_name':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Enter Building Name'}),'locality':forms.TextInput(attrs={'class':'form-control', 'placeholder':'Popular Place like Restaurant, Religious Site, etc.'}), 'city':forms.TextInput(attrs={'class':'form-control', 'placeholder':'City'}), 'state':forms.TextInput(attrs={'class':'form-control', 'placeholder':'State or Province'})}
