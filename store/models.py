...
class Address(models.Model):
    ...
    flat_no = models.CharField(max_length=150, verbose_name="House No.")
    building_name = models.CharField(max_length=150, verbose_name="Building Name")
...
class Product(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, verbose_name="Created Date")
    updated_at = models.DateTimeField(auto_now=True, verbose_name="Updated Date")
    t_model= models.FileField(upload_to='3dfile', max_length=200, blank=True, null=True, verbose_name="3D File")
...
class Order(models.Model):
    ...
    delivery_date = models.DateTimeField(auto_now_add=True, verbose_name="Delivery")
